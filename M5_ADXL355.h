...
public:
  ...
  /// ADXL355 Scale Factor at ±2g range: 3.9e-6G * 980.665cm/s2
  static constexpr float accelerationScaleFactorRange2G = 3.82459e-3;
  ...
  ADXL355(uint8_t sckPin,uint8_t miPin,uint8_t moPin,uint8_t csPin, uint32_t frequency = defaultSpiFrequency);
